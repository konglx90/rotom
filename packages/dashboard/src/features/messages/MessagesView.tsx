...
export function MessagesView() {
  ...
  const handleReset = () => {
    setFilters({ from: '', to: '', status: '', keyword: '', groupId: '', mentionFilter: '' })
    setPage(0)
  }
      ...
      <table className={styles.table}>
        ...
        <tbody>
          {loading ? (
            ...
            >
              <td className={styles.tsCell}>{formatTs(m.timestamp)}</td>
              <td>{m.from_name || '—'}</td>
              <td>{m.to_name || '—'}</td>
          ...
          <div className={styles.detailPanel}>
            ...
            <div className={styles.detailBody}>
              <div className={styles.detailGrid}>
                ...
                <div className={styles.detailValue}>{formatTs(selected.timestamp)}</div>
